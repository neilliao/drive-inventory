...
(() => {
 ...
 function openIllustratedRoute(i,b){
  ...
  note.textContent=[
   '圖中「辦事更細心，言行更合道」是編者依訓意整理的預期成效，不是仙佛原話。參照《聖佛綸音・文書篇》#68、#10，分別談稱職文書與言行合道。',
   '圖中「後學能承擔，傳承有人接」是編者依訓意整理的預期成效，不是仙佛原話。參照《聖佛綸音・文書篇》#63，談及早交棒與準備傳承。',
   '圖中「文字被理解，啟示能實踐」是編者依訓意延伸的規劃期待，不是仙佛原話。參照《聖佛綸音・文書篇》#74、#66，談以聖訓作修辦準繩、引導眾生與渡人成全。'
