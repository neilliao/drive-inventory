...
(()=>{
 ...
 <p class="fahui-boundary">2026-09-15 起對照靈隱中心《道場文獻工作參考手冊》（編輯中）：欄位已對齊、交付走四樣匯出，見<a href="2026-09-15-lingyin-wenxian-handbook-crosswalk.html">中心文獻手冊對照</a>；</p>
 <p class="fahui-boundary"><a href="#echo">與《聖佛綸音・文書篇》的呼應：十四條設計，各對回一則訓文 ↓</a>（點上圖的存、找、傳、承，也會看到該路的慈訓）</p>
